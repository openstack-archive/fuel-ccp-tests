...
class TestServiceHorizon(object):
    ...
    def test_horizon_component(self, config, underlay,
        ...
        ccp_actions.do_fetch()
        ccp_actions.update_service('horizon')
        k8s_actions.create_registry(remote)
        ccp_actions.do_build('builder_push',
        ...
        ccp_actions.do_deploy(registry_address=settings.REGISTRY,
