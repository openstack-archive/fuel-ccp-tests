...
class TestDeployOpenstack(base_test.SystemBaseTest):
    ...
    def test_fuel_ccp_deploy_microservices(self, config, underlay, k8s_actions,
                                           ccp_actions, k8scluster):
        ...
        if settings.BUILD_IMAGES:
            ...
            with remote.get_sudo(remote):
                ccp_actions.do_build(remote, *params_list, **params_dict)
        ...
        with remote.get_sudo(remote):
            ccp_actions.do_deploy(*params_list, **params_dict)
