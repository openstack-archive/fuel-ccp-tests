...
class K8sSecretManager(K8sBaseManager):
    ...
    def _list(self, **kwargs):
        return self.api.list_namespaced_secret(**kwargs)

    def _create(self, body, **kwargs):
        return self.api.create_namespaced_secret(body=body, **kwargs)
    ...
    def _deletecollection(self, **kwargs):
        return self.api.deletecollection_namespaced_secret(**kwargs)
