...
from mcp_tests.models import k8smanager
...
class TestFuelCCPInstaller(base_test.SystemBaseTest,
    ...
    def test_k8s_installed_default(self, config, underlay):
        ...
        Scenario:
            ...
            7. Delete pod.
        """
        k8smanager.K8SManager.install_k8s(underlay)
    ...
    def test_k8s_installed_with_etcd_on_host(self, config, underlay):
        ...
        k8smanager.K8SManager.install_k8s(underlay, custom_yaml=kube_settings)
        k8sclient = k8smanager.K8SManager.get_k8sclient(config)
        self.check_number_kube_nodes(underlay, k8sclient)
    ...
    def test_k8s_installed_with_ready_ssh_keys(self, ssh_keys_dir,
        ...
        k8smanager.K8SManager.install_k8s(underlay, env_var=add_var)
        k8sclient = k8smanager.K8SManager.get_k8sclient(config)
        self.check_number_kube_nodes(underlay, k8sclient)
        self.check_list_required_images(underlay, required_images=self.base_images)
        self.calico_ipip_exists(underlay)
