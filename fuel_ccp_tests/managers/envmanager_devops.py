...
class EnvironmentManager(object):
    ...
    def create_snapshot(self, name, description=None):
        ...
        if self._env is not None:
            ...
            raise exeptions.EnvironmentIsNotSet()
    ...
    def _create_environment(self):
        ...
        if self._devops_config.config is None:
            raise exeptions.DevopsConfigPathIsNotSet()
        ...
        if env_name is None:
            ...
            raise exeptions.EnvironmentNameIsNotSet()
        try:
            ...
            raise exeptions.EnvironmentAlreadyExists(env_name)
        self._env.define()
