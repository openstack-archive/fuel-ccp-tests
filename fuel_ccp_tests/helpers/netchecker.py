...
NETCHECKER_CONRAINER_PORT = NETCHECKER_SERVICE_PORT = 8081
        ...
        "containers": [
            {
                ...
                "ports": [
                    {
                        "containerPort": NETCHECKER_CONRAINER_PORT,
                        "hostPort": NETCHECKER_CONRAINER_PORT
                    }
                ]
            },
            {
        ...
        "ports": [
            {
                ...
                "protocol": "TCP",
                "targetPort": NETCHECKER_CONRAINER_PORT
            }
        ],
        "selector": {
            "app": "netchecker-server"
