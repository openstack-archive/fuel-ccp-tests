...
class TestCppLogging(object):
    ...
    def test_logging_kibana_running_single_node(
        ...
        """Test kibana running single node
                ...
                4. Build images or use external registry
                5. Deploy openstack
                6. Check kibana running single node
        """
        cluster = k8s_actions.api
    ...
    def test_logging_elastic_running_single_node(
        ...
        """Test elasticsearch running single node
                ...
                4. Build images or use external registry
                5. Deploy openstack
                6. Check elasticsearch running single node
        """
        cluster = k8s_actions.api
        pods_list = cluster.pods.list(namespace='ccp')
        elastic_count = len(
    ...
    def test_logging_heka_running_all_node(
            self,
            admin_node,
            os_deployed_stacklight,
            k8s_actions):
        """Test heka running all nodes
                ...
                4. Build images or use external registry
                5. Deploy openstack
                6. Check heka running on each node
        """
        cluster = k8s_actions.api
        pods_list = cluster.pods.list(namespace='ccp')
        ...
        assert set(nodes_list) == set(heka_nodes),\
            "Unexpected count of elasticsearch instances"
