...
class TestEntrypoint(object):
    ...
    @pytest.mark.pre_commit_entrypoint
    @pytest.mark.fail_snapshot
    def test_entrypoint(self, config, underlay,
                        k8scluster, ccpcluster):
        """Test fetch entypoint, build images, deploy OS
        Scenario:
        1. Fetch all repositories and update entrypoint
        ...
        ccpcluster.do_fetch()
        # Update entrypoint
        ccpcluster.update_service('entrypoint')
        # create registry
        ...
        command = [
            ...
            'cd {0}; ./{1} "--regex tempest.scenario"'.format(
