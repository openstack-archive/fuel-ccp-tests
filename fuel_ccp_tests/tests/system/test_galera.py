...
class TestGalera(base_test.SystemBaseTest):
    ...
    def test_deploy_galera(self, underlay, config, ccpcluster, k8s_actions):
        ...
        ccpcluster.deploy(params={"config-file": "./config_1.yaml"}, use_cli_params=True)
    ...
    def test_galera_shutdown_node(self, hardware, underlay, config, ccpcluster, k8s_actions):
    ...
    def test_galera_cold_restart_node(self, hardware, underlay, config, ccpcluster, k8s_actions):
    ...
    def test_galera_poweroff_node(self, hardware, underlay, config, ccpcluster, k8s_actions):
    ...
    def test_galera_soft_reboot_node(self, hardware, underlay, config, ccpcluster, k8s_actions):
    ...
    def test_galera_cluster_shutdown(self, hardware, underlay, config, ccpcluster, k8s_actions):
