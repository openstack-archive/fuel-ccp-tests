...
def admin_node(k8scluster, config, underlay, ccpcluster):
...
@pytest.yield_fixture(scope='module')
def elastic_client_public(k8scluster, admin_node, config):
...
def elastic_client_private(k8scluster, admin_node, config):
    k8sclient = k8scluster.get_k8sclient(default_namespace="ccp")
...
@pytest.yield_fixture(scope='module')
def kibana_public_endpoint(k8scluster, admin_node, config):
...
class TestCppLogging(object):
    ...
    def test_logging_connection_to_elasticsearch_private(
            self, admin_node, k8scluster, elastic_client_private):
        """Elasticsearch api test
                Scenario:
                1. Install k8s
                2. Install microservices
    ...
    def test_logging_search_for_logs_from_all_running_heka_instances(
            self, k8scluster, elastic_client_public):
    ...
    def test_logging_trigger_event_into_mysql(self, admin_node,
                                      k8scluster, elastic_client_public):
        ...
        res = admin_node.check_call(
            'kubectl exec {} --namespace={} {}'.format(
                mysql_pod.name,
                ext.Namespace.BASE_NAMESPACE,
                'sed -- -i -- \'$ a\{}\' /var/log/ccp/mysql/mysql.log'
                    .format(mysql_template)),
    ...
    def test_logging_trigger_event_into_rabitmq(self, admin_node,
                                        k8scluster, elastic_client_public):
    ...
    def test_logging_attributes_for_openstack_horizon_apache_message(self,
            elastic_client_public):
    ...
    def test_logging_attributes_for_openstack_keystone_message(self,
            elastic_client_public):
    ...
    def test_logging_attributes_for_openstack_keystone_apache_message(self,
            elastic_client_public):
    ...
    def test_logging_attributes_for_openstack_nova_message(self,
            elastic_client_public):
    ...
    def test_logging_attributes_for_openstack_neutron_message(self,
            elastic_client_public):
    ...
    def test_logging_attributes_for_openstack_glance_message(self,
                                                     elastic_client_public):
    ...
    def test_logging_attributes_for_openstack_heat_message(self,
                                                   elastic_client_public):
    ...
    def test_logging_attributes_for_openvswitch_message(self,
                                               elastic_client_public):
    ...
    def test_logging_explore_indexes_with_kibana(self, admin_node,
    ...
    def test_logging_log_rotate_for_mysql(self, admin_node, k8scluster):
