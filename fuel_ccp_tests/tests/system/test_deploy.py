...
class TestDeployOpenstack(base_test.SystemBaseTest):
    ...
    def create_registry(self, remote):
        registry_pod = os.getcwd() + '/fuel_ccp_tests/tests/fixtures/templates/' \
                                     'registry_templates/registry-pod.yaml'
        service_registry = os.getcwd() + '/fuel_ccp_tests/tests/fixtures/' \
    ...
    def pre_build_deploy_step(self, remote):
        topology_path = os.getcwd() + '/fuel_ccp_tests/tests/fixtures/templates/' \
    ...
    def test_fuel_ccp_deploy_microservices(self, config, underlay):
        ...
        if settings.BUILD_IMAGES:
            ...
            exclude_list = ['deploy']
            yaml_path = os.getcwd() + '/fuel_ccp_tests/tests/fixtures/templates/' \
