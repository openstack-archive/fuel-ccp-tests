...
class TestDeployTwoOS(base_test.SystemBaseTest):
    ...
    @pytest.mark.system
    def test_deploy_two_os(self, underlay, config, ccpcluster, k8s_actions, rally):
        ...
        underlay.sudo_check_call("sudo pip install python-openstackclient",
