...
class TestDeployTwoOS(base_test.SystemBaseTest):
    ...
    @pytest.mark.fail_snapshot
    @pytest.mark.system_few_os
    def test_deploy_two_os_same_ctrl(self, underlay, config, ccpcluster, k8s_actions):
        """Deploy base environment
    ...
    @pytest.mark.fail_snapshot
    @pytest.mark.system_few_os
    def test_deploy_two_os_kill_keystone(self, underlay,
                                         config, ccpcluster, k8s_actions):
        """Deploy base environment
    ...
    @pytest.mark.fail_snapshot
    @pytest.mark.system_few_os
    def test_deploy_two_os_kill_nova(self, underlay, config, ccpcluster, k8s_actions):
        """Deploy base environment
