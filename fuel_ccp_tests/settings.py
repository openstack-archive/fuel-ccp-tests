...
E2E_CONFORMANCE_IMAGE_REPO = os.environ.get("E2E_CONFORMANCE_IMAGE_REPO",
                                            "mirantis/k8s-conformance")
E2E_CONFORMANCE_IMAGE_TAG = os.environ.get("E2E_CONFORMANCE_IMAGE_TAG",
                                           "latest")
